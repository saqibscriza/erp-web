            ...
            <Box sx={{
                ...
                <Container maxWidth={false} sx={{ borderBottom: "1px solid white" }}>
                    ...
                    <Grid container spacing={{ xs: 0, md: 3 }} >
                        <Grid size={{ xs: 12, lg: 4 }} >
                            <Box sx={{
                                ...
                                <Box>
                                    ...
                                    <Typography sx={{ textWrap: "no-wrap" }}>A-4-5, A Block, Sector 16, Noida</Typography>
                                </Box>
                            </Box>
                        </Grid>
                        ...
                        <Grid size={{ xs: 12, lg: 4 }}>
                            <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', py: 4, pl: { xs: 4, lg: 9 }, }}>
                ...
                <Container maxWidth="lg" sx={{ py: 4, }}>
                    <Grid container spacing={4} sx={{ display: 'flex' }}>
                        ...
                        <Grid sx={{ pl: { xs: 5, md: 0 } }} size={{ xs: 12, md: 4 }}>
                            <Typography component="h3" sx={{ fontWeight: 700, mb: 2 }}>Our Services:</Typography>
                        ...
                        >
                            <Box sx={{ display: "flex", flexDirection: "column" }}>
                                ...
                                <OutlinedInput
                                    ...
                                    size="small"
                                    sx={{ bgcolor: '#fff', borderRadius: 1, mb: 2, width: '100%', maxWidth: "300px", p: 1 }}
                                />
                                <Button variant="contained" sx={{ bgcolor: '#086159', color: '#fff', maxWidth: "200px", p: 2 }}>
                                    Subscribe Now
                                </Button>
                            </Box>
                        </Grid>
